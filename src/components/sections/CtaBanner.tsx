    ...
    <section className="bg-slate-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="bg-slate-900 rounded-3xl p-8 md:p-12 lg:p-16 relative overflow-hidden"
        >
          {/* Decorative graphic */}
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="flex-shrink-0 w-full md:w-auto flex flex-col sm:flex-row gap-4">
              <a 
                href="#konfigurator"
                className="bg-indigo-600 text-white px-8 py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 hover:bg-indigo-700 transition-colors"
              >
