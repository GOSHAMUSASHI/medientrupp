            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="relative mb-6">
                  <div className="w-[100px] h-[100px] bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600">
                    {step.icon}
                  </div>
                  {/* Step number badge — scharf eckig */}
                  <span className="absolute -top-2.5 -right-2.5 w-7 h-7 bg-indigo-600 text-white text-[11px] font-black flex items-center justify-center">
                    {step.number}
                  </span>
                </div>

                {/* Tag */}
                <span className="text-[10px] font-bold tracking-[0.15em] uppercase text-indigo-600 border border-indigo-100 bg-indigo-50 px-3 py-1 mb-4">
                  {step.tag}
                </span>
